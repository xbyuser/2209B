    ...
    common_vendor.index.request({
      ...
      success: (res) => {
        if (res.statusCode == 200) {
          ...
          common_vendor.index.navigateTo({ url: "/pages/login-page/index" });
          reject(res);
          ...
          common_vendor.index.showToast({ title: res.data.msg, icon: "none", duration: 1e3 });
          reject(res);
        } else {
          common_vendor.index.showToast({
            title: "\u670D\u52A1\u5668\u53D1\u751F\u672A\u77E5\u9519\u8BEF",
...
const RequestApi = {
  ...
  WeaTher: (data) => request("weather", "GET", data),
  EpidEmic: (data) => request("epidemic", "GET", data)
};
