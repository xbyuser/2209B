...
const skIndex = () => "../../Skeleton/SK-phy-details.js";
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.onLoad(async (event) => {
      let eventData = event;
      const res = await public_request.RequestApi.PhydaTeil({ id: eventData.id });
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        g: common_vendor.o(memBer),
        h: common_vendor.sr(compNone, "5a35890c-0", {
          "k": "compNone"
        }),
        i: common_vendor.unref(skeLeton)
      }, common_vendor.unref(skeLeton) ? {} : {});
    };
  }
});
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/\u5317\u7F51-\u524D\u7AEF\u8D44\u6599/1708/JS\u7EC3\u4E60/uni-app\u6846\u67B6\u9879\u76EE/vue3+ts\u533B\u4F9D\u901A\u9879\u76EE\u5305uniapp\u7248/\u533B\u4F9D\u901A/src/pages/phy-exam/Details.vue"]]);
