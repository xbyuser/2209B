<template>
  <div class="dashboard-container">
    ...
    <el-dialog title="分配权限" :visible.sync="showPermissionDialog">
      <el-tree ref="permTree" node-key="id" check-strictly :data="permData" :default-checked-keys="permIds" :props="{ label: 'name' }" default-expand-all show-checkbox />
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
