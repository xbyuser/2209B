...
//世界疫情图-参考图https://www.makeapie.com/editor.html?c=map-world-dataRange  ！！！注意一般地图类图表的，都需要下载地图的数据js文件。点击外部脚本下载下，项目中引入即可  import 'commonfun/world.js'
export function worldMapOption(){
	let option = {
		    ...
		    series: [{
		        ...
		        // 指定地图名称
		        mapType: 'world',
		        // 地区名称映射(中英文转换)-！！！注意要引入中英文转换文件nameMap.js
		        nameMap: '',
		        // 图表所绘制区域样式
		        itemStyle: {
		            emphasis: {
